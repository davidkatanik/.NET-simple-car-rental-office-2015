...
namespace ORM_KAT0013.Database
{
    public class PronajemTable
    {
        ...
        private void PrepareCommand(SqlCommand command, Pronajem pronajem)
        {
            ...
            command.Parameters.Add(new SqlParameter("@poznamka", SqlDbType.VarChar, pronajem.Poznamka.Length));
            ...
            command.Parameters.Add(new SqlParameter("@spz", SqlDbType.VarChar, pronajem.SPZ.SPZ.Length));
